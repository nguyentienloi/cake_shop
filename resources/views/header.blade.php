			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 328 Nguyễn Trãi,Thanh xuân, Hà Nội</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0332155830</a></li>
					</ul>
				</div>
				<div class="pull-right auto-width-right">
					<ul class="top-details menu-beta l-inline">
						@if(Auth::check())
						<li style="border:none;margin-top: 13px;"><p> Xin chào {{Auth::user()->full_name}}</p></li>
						<li style="border:none;"><a href="{{route('logout')}}">Đăng xuất</a></li>
						@else
		...
		<div class="header-body">
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						<form role="search" method="get" id="searchform" action="{{route('search_product')}}">
					        <input type="text" value="" name="search_pro" id="s" placeholder="Nhập từ khóa..." />
